...
[![Tests](https://github.com/tylerphelan/duffel/actions/workflows/ci.yaml/badge.svg)](https://github.com/tylerphelan/duffel/actions/workflows/ci.yaml)
...
```shell
go get github.com/tylerphelan/duffel
```
...
- [GoDoc Documentation](https://pkg.go.dev/github.com/tylerphelan/duffel#section-documentation)
